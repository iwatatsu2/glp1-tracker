    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-app">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center pb-2">
          <div className="size-16 rounded-2xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center mx-auto mb-3">
            <Syringe className="size-8 text-primary-foreground" />
          </div>
          <CardTitle className="text-xl">GLP-1 Tracker</CardTitle>
